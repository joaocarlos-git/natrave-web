...
export function Home(){
  ...
  return(
    ...
    <div className="container container max-w-5xl flex-1 p-4 flex felx-col items-center md: flex-row space-y-6 md:space-y-0 md:space-x-6">

      <div className="md:flex-1 flex justify-center">
        <img src="/imgs/photo.png" className="w-full max-w-md" />
      </div>

<div className="md:flex-1 flex-1 flex flex-col space-y-6">
